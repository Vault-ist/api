# Get SMS Code to Show Card Details

`GET` **/v2/card/{cardId}/details/code**
...
- **cardId**: *integer<int64>* *(required)*
  - Unique identifier of the card for which the SMS code is being obtained.
...
- **result**: *string* 
  - A status message indicating the outcome of the request to generate an SMS code for displaying card details.
